...
- {id: CLK16K1_toVSYS_clock.outFreq, value: 16.384 kHz}
...
- {id: CTIMER3_clock.outFreq, value: 12 MHz}
...
- {id: CLK16K1_VSYS_EN, value: Enabled}
...
- {id: SYSCON.CTIMERCLKSEL1.sel, value: SCG.FRO_12M}
- {id: SYSCON.CTIMERCLKSEL2.sel, value: SCG.FRO_12M}
- {id: SYSCON.CTIMERCLKSEL3.sel, value: SCG.FRO_12M}
...
void BOARD_BootClockFRO12M(void)
{
    ...
    CLOCK_SetupClk16KClocking(kCLOCK_Clk16KToVsys);      /* FRO16 kHz output clock to Vsys enabled */
    ...
    CLOCK_AttachClk(kFRO12M_to_CTIMER1);                 /*!< Switch CTIMER1 to FRO12M */
    CLOCK_AttachClk(kFRO12M_to_CTIMER2);                 /*!< Switch CTIMER2 to FRO12M */
    CLOCK_AttachClk(kFRO12M_to_CTIMER3);                 /*!< Switch CTIMER3 to FRO12M */
